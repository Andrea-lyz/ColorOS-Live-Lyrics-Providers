 ...
 */
internal object QQMusicQrcWordTimePolicy {
    ...
    fun resolveForQQMusicQrc(
        ...
        return QQMusicQrcWordTimeAxis(lineBegin, usesRelativeOffsets)
    }
}

internal data class QQMusicQrcWordTimeAxis(
