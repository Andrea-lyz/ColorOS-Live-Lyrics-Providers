...
/**
 * The module-app settings layer must never reference legacy Xposed, Yuki or world-readable
 * preference paths during the v4.1 migration.
 */
class SettingsLegacyGuardTest {
