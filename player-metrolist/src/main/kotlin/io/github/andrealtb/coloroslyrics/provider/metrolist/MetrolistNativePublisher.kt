...
object MetrolistNativePublisher {

    fun publish(
        session: MediaSession?,
        metadata: MediaMetadata?,
        publication: MetrolistPublication,
        track: TrackIdentity,
        trackGeneration: Long,
        generationPolicy: TrackGenerationPolicy,
        registry: MetrolistMediaSessionRegistry,
        hostPackage: String
        ...
        if (!MetrolistMetadataArtwork.isReadyForLyricInfo(live)) {
        ...
        val hostTrack = MetrolistMediaSessionRegistry.trackFrom(live)
